...
class Expr12Parser ( Parser ):

    grammarFileName = "Expr12.g4"
    ...
    class ProgContext(ParserRuleContext):
        ...
        def e(self):
            return self.getTypedRuleContext(Expr12Parser.EContext,0)


        def EOF(self):
            return self.getToken(Expr12Parser.EOF, 0)

        def getRuleIndex(self):
            return Expr12Parser.RULE_prog
    ...
    def prog(self):
        ...
        localctx = Expr12Parser.ProgContext(self, self._ctx, self.state)
    ...
    class SumaContext(EContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a Expr12Parser.EContext
        ...
        def t(self):
            return self.getTypedRuleContext(Expr12Parser.TContext,0)
    ...
    def e(self, _p:int=0):
        ...
        localctx = Expr12Parser.EContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        self.enterRecursionRule(localctx, 2, self.RULE_e, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = Expr12Parser.A_TContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = Expr12Parser.SumaContext(self, Expr12Parser.EContext(self, _parentctx, _parentState))
    ...
    class MultContext(TContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a Expr12Parser.TContext
            super().__init__(parser)
            self.copyFrom(ctx)
        ...
        def f(self):
            return self.getTypedRuleContext(Expr12Parser.FContext,0)
    ...
    def t(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = Expr12Parser.TContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 4
        self.enterRecursionRule(localctx, 4, self.RULE_t, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = Expr12Parser.A_FContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = Expr12Parser.MultContext(self, Expr12Parser.TContext(self, _parentctx, _parentState))
    ...
    class ParensContext(FContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a Expr12Parser.FContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class NumContext(FContext):
        ...
        def NUM(self):
            return self.getToken(Expr12Parser.NUM, 0)
    ...
    class IdContext(FContext):
        ...
        def ID(self):
            return self.getToken(Expr12Parser.ID, 0)
    ...
    def f(self):
        ...
        localctx = Expr12Parser.FContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [5]:
                localctx = Expr12Parser.IdContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 33
                self.match(Expr12Parser.ID)
                pass
            elif token in [6]:
                localctx = Expr12Parser.NumContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 34
                self.match(Expr12Parser.NUM)
                pass
            elif token in [3]:
                localctx = Expr12Parser.ParensContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 35
                self.match(Expr12Parser.T__2)
                self.state = 36
                self.e(0)
                self.state = 37
                self.match(Expr12Parser.T__3)
                pass
            else:
