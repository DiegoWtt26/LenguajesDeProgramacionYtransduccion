...
class PrecLeftParser ( Parser ):

    grammarFileName = "PrecLeft.g4"
    ...
    class ProgContext(ParserRuleContext):
        ...
        def e(self):
            return self.getTypedRuleContext(PrecLeftParser.EContext,0)


        def EOF(self):
            return self.getToken(PrecLeftParser.EOF, 0)

        def getRuleIndex(self):
            return PrecLeftParser.RULE_prog
    ...
    def prog(self):
        ...
        localctx = PrecLeftParser.ProgContext(self, self._ctx, self.state)
    ...
    class A_TContext(EContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecLeftParser.EContext
            super().__init__(parser)
            self.copyFrom(ctx)

        def t(self):
            return self.getTypedRuleContext(PrecLeftParser.TContext,0)
    ...
    def e(self, _p:int=0):
        ...
        localctx = PrecLeftParser.EContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = PrecLeftParser.A_TContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = PrecLeftParser.SumaRestaContext(self, PrecLeftParser.EContext(self, _parentctx, _parentState))
    ...
    class A_FContext(TContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecLeftParser.TContext
            super().__init__(parser)
            self.copyFrom(ctx)

        def f(self):
            return self.getTypedRuleContext(PrecLeftParser.FContext,0)
    ...
    def t(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = PrecLeftParser.TContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 4
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = PrecLeftParser.A_FContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = PrecLeftParser.MultDivContext(self, PrecLeftParser.TContext(self, _parentctx, _parentState))
    ...
    class ParensContext(FContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecLeftParser.FContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class NumContext(FContext):
        ...
        def NUM(self):
            return self.getToken(PrecLeftParser.NUM, 0)
    ...
    def f(self):
        ...
        localctx = PrecLeftParser.FContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [7]:
                localctx = PrecLeftParser.NumContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 33
                self.match(PrecLeftParser.NUM)
                pass
            elif token in [5]:
                localctx = PrecLeftParser.ParensContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 34
                self.match(PrecLeftParser.T__4)
                self.state = 35
                self.e(0)
                self.state = 36
                self.match(PrecLeftParser.T__5)
                pass
            else:
