...
class PrecInvParser ( Parser ):

    grammarFileName = "PrecInv.g4"
    ...
    class ProgContext(ParserRuleContext):
        ...
        def e(self):
            return self.getTypedRuleContext(PrecInvParser.EContext,0)


        def EOF(self):
            return self.getToken(PrecInvParser.EOF, 0)

        def getRuleIndex(self):
            return PrecInvParser.RULE_prog
    ...
    def prog(self):
        ...
        localctx = PrecInvParser.ProgContext(self, self._ctx, self.state)
    ...
    class A_TContext(EContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecInvParser.EContext
            super().__init__(parser)
            self.copyFrom(ctx)

        def t(self):
            return self.getTypedRuleContext(PrecInvParser.TContext,0)
    ...
    def e(self, _p:int=0):
        ...
        localctx = PrecInvParser.EContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = PrecInvParser.A_TContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = PrecInvParser.MultDivContext(self, PrecInvParser.EContext(self, _parentctx, _parentState))
    ...
    class A_FContext(TContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecInvParser.TContext
            super().__init__(parser)
            self.copyFrom(ctx)

        def f(self):
            return self.getTypedRuleContext(PrecInvParser.FContext,0)
    ...
    class SumaRestaContext(TContext):
    ...
    def t(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = PrecInvParser.TContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 4
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = PrecInvParser.A_FContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = PrecInvParser.SumaRestaContext(self, PrecInvParser.TContext(self, _parentctx, _parentState))
    ...
    class ParensContext(FContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a PrecInvParser.FContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class NumContext(FContext):
        ...
        def NUM(self):
            return self.getToken(PrecInvParser.NUM, 0)
    ...
    def f(self):
        ...
        localctx = PrecInvParser.FContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [7]:
                localctx = PrecInvParser.NumContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 33
                self.match(PrecInvParser.NUM)
                pass
            elif token in [5]:
                localctx = PrecInvParser.ParensContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 34
                self.match(PrecInvParser.T__4)
                self.state = 35
                self.e(0)
                self.state = 36
                self.match(PrecInvParser.T__5)
                pass
            else:
